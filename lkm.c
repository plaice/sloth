...
char *argv[];
  ...
  {char *ImpList[MAXUSE], *UseeImpList[MAXUSE], *ccList[MAXUSE+5];
   int  i, ImpCount, UseeImpCount;
   ...
   ccList[1] = "-o" ;
   ccList[2] = ImpList[0] ;
   ccList[3] = stringcat(ImpList[0],stringcat(".m/",
		OptSource(stringcat(ImpList[0],".m/main.c"))));
   ccList[4] = (char *)0 ;
   ...
   switch (fork())
     { case 0 : for (i = 0 ; ccList[i] != (char *)0 ; i++)
